      ...
      <main className="sub-main">
        <div className="sub-main-left">
          ...
          <article className="sub-article">
            ...
            <p>Available treatment options can differ based on the type of arthritis, its severity and a person's overall health and lifestyle. Several treatment options can provide arthritis pain relief and help manage your symptoms.</p>
            <ul>
            ...
            <div className="sub-explore">
              ...
              <ul>
                <li>
                  <button className="button-link" onClick={() => window.location.href = '/blog/healthy-eating'}>
                    Healthy Eating Habits for Better Health
                  </button>
                </li>
                <li>
                  <button className="button-link" onClick={() => window.location.href = '/blog/exercise-tips'}>
                    Exercise Tips for Beginners
                  </button>
                </li>
                <li>
                  <button className="button-link" onClick={() => window.location.href = '/blog/mental-health'}>
